...
Comparing example_db_rand1.top.blast.out (first line, random shuffling of initial database) and example_db_top.blast.out (second line, original database)
```
